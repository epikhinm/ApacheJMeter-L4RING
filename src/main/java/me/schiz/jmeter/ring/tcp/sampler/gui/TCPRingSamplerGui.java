 ...
 * 
 */
package me.schiz.jmeter.ring.tcp.sampler.gui;
...
import me.schiz.jmeter.ring.tcp.sampler.TCPRingSampler;
import org.apache.jmeter.samplers.gui.AbstractSamplerGui;
import org.apache.jmeter.testelement.TestElement;
import org.apache.jorphan.logging.LoggingManager;
import org.apache.log.Logger;

public class TCPRingSamplerGui extends AbstractSamplerGui {
	...
	public TestElement createTestElement() {
		TCPRingSampler sampler = new TCPRingSampler();
	...
	public void configure(TestElement te) {
		super.configure(te);
		if(te instanceof TCPRingSampler) {
			TCPRingSampler sampler =(TCPRingSampler)te;
	...
	public void modifyTestElement(TestElement testElement) {
		...
		if (testElement instanceof TCPRingSampler) {
			TCPRingSampler sampler = (TCPRingSampler) testElement;
	...
	private void initFields() {
		this.tfName.setText("TCPRing Sampler");
		this.tfComments.setText("developed by Epikhin Mikhail epikhinm@gmail.com");

		this.tfSource.setText(TCPRingSourceElement.DEFAULT_SOURCE);
